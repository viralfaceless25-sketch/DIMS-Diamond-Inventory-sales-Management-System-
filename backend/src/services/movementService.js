const MOVEMENT_LABELS = Object.freeze({
  ...
  physical_receipt_recorded: 'Physical receipt recorded',
  physical_receipt_corrected: 'Physical receipt corrected',
  physical_receipt_linked: 'Physical receipt linked',
